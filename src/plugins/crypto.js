    ...
    commands: [
        {
            ...
            async run(bot, msg) {
                ...
                switch (msg.args[0]) {
                    case "us": {
                        try {
                            const req = await fetch('https://www.bitstamp.net/api/v2/ticker/btcusd', { method: 'GET', headers: { 'User-Agent': bot.constants.USER_AGENT } });
                    ...
                    case "eu": {
                        try {
                            const requ = await fetch('https://www.bitstamp.net/api/v2/ticker/btceur', { method: 'GET', headers: { 'User-Agent': bot.constants.USER_AGENT } });
